    ...
    async with httpx.AsyncClient() as client:
        try:
            response = await client.post(
                ...
                data={
                    "from": f"Ismael Setti <mailgun@{config.MAILGUN_DOMAIN}>",
                    "to": [to],
                    "subject": subject,
                    "text": body,
                },
...
async def generate_and_add_to_post(
    ...
    try:
        ...
        return await send_simple_email(
            ...
            (
                f"Hi {email}! Unfurtunately there was an error generating an image"
                " for your post."
            ),
        )
    ...
    await send_simple_email(
        ...
        (
            f"Hi {email}! Your iamge has been generated and added to your post."
