...
def mock_b2_upload_file(mocker):
    return mocker.patch(
        "social_media_api.routers.upload.b2_upload_file",
        return_value="https://fakeurl.com",
    )


# fixture explanation: https://www.udemy.com/course/rest-api-fastapi-python/learn/lecture/39329992?start=364#notes
@pytest.fixture(autouse=True)
